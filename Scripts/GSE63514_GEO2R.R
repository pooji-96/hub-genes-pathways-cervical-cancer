...
gsms <- paste0("00000000000000000000000011111111111111111111111111",
...
for (i in 1:3) {
  ...
  volcanoplot(fit2, coef = i, 
              ...
              main = paste("GSE63514 -", colnames(fit2)[i]), 
              xlim = c(-10, 10), ylim = c(0, max(-log10(pval), 20)),
...
for (i in 1:3) {
  ...
  writeLines(unique_up_genes, paste0("DEG/GSE63514/GSE63514_", cts[i], "_upregulated_gene_symbols.txt"))
  writeLines(unique_down_genes, paste0("DEG/GSE63514/GSE63514_", cts[i], "_downregulated_gene_symbols.txt"))
}
